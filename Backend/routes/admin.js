...
/**
 * @route   POST /api/admin/applications/:id/shortlist
 * @desc    Shortlist applicant and send email
 * @access  Admin only
 */
router.post('/applications/:id/shortlist', protect, authorize('ADMIN'), adminController.shortlistApplicant);
 ...
 * @access  Admin only
 */
router.post('/applications/:id/reject', protect, authorize('ADMIN'), adminController.rejectApplicant);
